...
import { FiEye, FiTarget, FiShield, FiCheckCircle } from "react-icons/fi";
import { HiOutlineLightBulb, HiOutlineGlobeAlt } from "react-icons/hi2";
import { TbLeaf } from "react-icons/tb";
import { FaRegHandshake } from "react-icons/fa";

// 🖼️ Your PNG icons
const visionIcon = "/img/about/vision.png";
const missionIcon = "/img/about/mission.png";
const valuesIcon = "/img/about/value.png";

// PNG icon map (ONLY for top cards)
const cardIcons: Record<string, string> = {
  "Our Vision": visionIcon,
  "Our Mission": missionIcon,
  "Our Core Values": valuesIcon,
};

// Core values bullet icons (UNCHANGED)
...
const WhyChooseUsGrid = ({ data }: { data: SectionProps }) => {
  const { wrapperCls, container, subheading, heading, text, promotions } =
    data || {};
      ...
      <div className={container}>
        ...
        <div className="choose-top">
          <div
            ...
            className="choose-us-content section-headings"
          >
            {subheading && (
                ...
                >
                  <div className="vmv-card">
                    ...
                    <div className="vmv-icon-ring">
                      {cardIcons[item.title || ""] ? (
                        <div className="vmv-icon-plain">
                          <img
                            style={{
                              marginLeft: "-26px",
                              transform:
