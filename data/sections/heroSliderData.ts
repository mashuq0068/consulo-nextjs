export const HeroSlidesData = [
  {
    ...
    text: "Kirti Bhavya Enterprises Private Limited (KBEPL) is a growth-driven enterprise engaged in Global Trading, Food Distribution, and Tech-Enabled Retail. Built on the foundations of global experience, operational excellence, and long-term business relationships.",
    button: {
      label: "Learn More",
      href: "/about-us",
      type: "secondary"
...

  {
    ...
    image: "https://elements-resized.envatousercontent.com/envato-dam-assets-production/EVA/TRX/91/0a/fa/90/0e/v1_E10/E105B6S5.jpeg?w=800&cf_fit=scale-down&q=85&format=auto&s=2341fa79733106fb41fcfc1b8dafbe3dbf8fb8e141340abcb737a80b841f8c06",
    imageTablet: "/img/slider/hero-main.jpg",
    imageMobile: "/img/slider/hero-main.jpg"
  },
